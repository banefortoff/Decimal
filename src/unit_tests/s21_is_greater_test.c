...
START_TEST(s21_test_is_greater_2_1) {
  s21_decimal a = {{UINT_MAX, 0, 0, 0}};
...
START_TEST(s21_test_is_greater_4_1) {
...
START_TEST(s21_test_is_greater_5_1) {
  s21_decimal a = {{UINT_MAX, UINT_MAX, 0, 0}};
...
Suite *suite_is_greater(void) {
  ...
  tcase_add_test(tc, s21_test_is_greater_2_1);
  tcase_add_test(tc, s21_test_is_greater_3);
  tcase_add_test(tc, s21_test_is_greater_4);
  tcase_add_test(tc, s21_test_is_greater_4_1);
  tcase_add_test(tc, s21_test_is_greater_5);
  tcase_add_test(tc, s21_test_is_greater_5_1);
