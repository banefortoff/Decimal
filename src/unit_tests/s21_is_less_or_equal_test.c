...
START_TEST(s21_test_is_less_or_equal_2_1) {
...
START_TEST(s21_test_is_less_or_equal_4_1) {
...
START_TEST(s21_is_less_or_equalTest0) {
  s21_decimal src1 = {{0}};
  s21_decimal src2 = {{0}};
...
Suite *suite_is_less_or_equal(void) {
  ...
  tcase_add_test(tc, s21_test_is_less_or_equal_2_1);
  tcase_add_test(tc, s21_test_is_less_or_equal_3);
  tcase_add_test(tc, s21_test_is_less_or_equal_4);
  tcase_add_test(tc, s21_test_is_less_or_equal_4_1);
  ...
  tcase_add_test(tc, s21_is_less_or_equalTest0);
