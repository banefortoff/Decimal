...
START_TEST(s21_test_decimal_sub_simple_4) {  // 1-(-1)=2
...
START_TEST(s21_test_decimal_sub_simple_5) {  // -1-(-1)=0
...
START_TEST(s21_test_decimal_sub_simple_6) {  // 1-(-1)=2
  s21_decimal c = {{100, 0, 0, 0}};
...
START_TEST(s21_test_decimal_sub_simple_7) {  // -1-(-1)=0
...
Suite *suite_sub(void) {
  ...
  tcase_add_test(tc, s21_sub_int_18);
  tcase_add_test(tc, s21_sub_int_19);
  tcase_add_test(tc, s21_sub_int_20);
  tcase_add_test(tc, s21_sub_int_21);
  tcase_add_test(tc, s21_sub_int_22);
  tcase_add_test(tc, s21_sub_inf_23);

  tcase_add_test(tc, s21_sub_neg_inf_24);

  tcase_add_test(tc, s21_sub_max_25);
  tcase_add_test(tc, s21_sub_max_26);
